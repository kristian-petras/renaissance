...
lazy val kotlinWebBenchmarks = (project in file("benchmarks/kotlin-web"))
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      ...
      "org.http4k" % "http4k-server-jetty" % "5.31.0.0",
      "org.http4k" % "http4k-server-undertow" % "5.31.0.0",
      "org.http4k" % "http4k-server-helidon" % "5.31.0.0",
      "org.http4k" % "http4k-client-apache" % "5.31.0.0",
      "org.http4k" % "http4k-client-jetty" % "5.31.0.0",
      "org.http4k" % "http4k-client-okhttp" % "5.31.0.0",
      "org.http4k" % "http4k-client-helidon" % "5.31.0.0",
